#
# Module manifest for module 'DeeplTranslate'
#
...
@{
    ...
    GUID                 = 'd8b7fe83-6e64-4e91-9654-1ea8308f3470'
    ...
    Description          = 'PowerShell Module for using the DeepL translation API'
    ...
    TypesToProcess       = @('Types\DeeplTranslate.Text.ps1xml'
    )
    ...
    FunctionsToExport    = @('Get-DeeplGlossary';
    ...
    PrivateData          = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'https://github.com/admins-little-helper/DeeplTranslate/blob/main/ReleaseNotes.md'
